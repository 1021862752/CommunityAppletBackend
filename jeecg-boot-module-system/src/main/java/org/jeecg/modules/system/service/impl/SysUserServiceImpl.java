...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements ISysUserService {
	...
	@Override
	@Transactional
	public void editUserById(SysUser user) {
...
//		info.setSysUserName(user.getRealname());
	...
	@Override
	public SysUser getUserByOpid(String id) {
		return userMapper.getUserByOpid(id);
	}
...
//		this.save(user);  //保存角色的时候已经添加过一次了
	...
	@Override
	public boolean updateUserByOpid(String id, SysUser updateEntity) {
		return userMapper.updateUserByOpid(id, updateEntity) > 0;
	}
